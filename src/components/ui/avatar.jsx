...
const AvatarFallback = React.forwardRef(({ className, ...props }, ref) => <AvatarPrimitive.Fallback ref={ref} className={cn("flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-purple-300 to-pink-300 text-white font-black", className)} {...props} />)
